      ...
      <div className="container mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <img
              src={calicutImg}
              alt="Calicut coastline at golden hour"
          ...
          <motion.div {...fadeInUp} transition={{ ...fadeInUp.transition, delay: 0.15 }}>
            ...
            <h2 className="text-display text-4xl md:text-5xl tracking-tight text-foreground leading-[1.1] mb-6">
              Heal where history{" "}
              <em className="text-display italic">meets the sea</em>
            </h2>
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                Calicut — the city of spices, trade, and timeless hospitality. A prosperous
                port city with roots stretching back millennia, where Zamorin kings once
                welcomed the world.
              </p>
              <p>
                Today, it's a vibrant blend of traditional Kerala architecture and modern
                energy. World-class cuisines — from Malabar biryani to fresh-caught seafood —
                sit alongside heritage temples, mosques, and colonial architecture.
              </p>
              <p>
                Steps from the beach, surrounded by local delights and cultural richness,
                Hitech Medicity is perfectly positioned for healing that extends beyond
                the clinical.
              </p>
            </div>
